...
pipeline = utility.pipeline_setup(svm) #pipeline obj to be used in all algos

pipeline_fitted = pipeline.fit(docs_train.data, docs_train.target)
svm_predict = pipeline_fitted.predict(docs_test.data)
